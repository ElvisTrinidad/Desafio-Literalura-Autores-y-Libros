package com.desafioLiteralura.principal;
...
import com.desafioLiteralura.service.Datos;
import com.desafioLiteralura.service.DatosAutor;
import com.desafioLiteralura.service.DatosLibro;
import com.desafioLiteralura.service.ConsumoAPI;
import com.desafioLiteralura.service.ConvierteDatos;
...
public class Principal {
    ...
    private Datos obtenerDatosLibro(String tituloLibro) {
        try {
            ...
            // Deserializa el JSON
            Datos datosLibro = conversor.obtenerAutor(json, Datos.class);
